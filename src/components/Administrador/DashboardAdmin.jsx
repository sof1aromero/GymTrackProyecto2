...
import Footer from "../InicioSesionFN/Footer"; // 👈 importamos el footer
            ...
            <div className="main-content">
                <main className="dashboard-content">
                    <Routes>
                        ...
                        <Route path='/registro' element={<RegistroEntrenadores />} />
                        <Route path='/pagos' element={<GestionPagos />} />
                        <Route path='/inventario' element={<InventarioGym />} />
                        <Route path='/miembros' element={<VerMiembros />} />
                        <Route path='/coaches' element={<VerEntrenadores />} />
